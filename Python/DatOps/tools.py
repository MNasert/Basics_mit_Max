...
def reformat(keywordss_t_e, text):#wir erhalten eine liste mit keywords die wir excluden und einen text
    text = text.split(keywordss_t_e[1])#Was macht split? "Das ist ein" -> ["Das", "ist", "ein"]- wir übergeben ein keyword nach dem wir immer splitten- statt space also keyword[1]
